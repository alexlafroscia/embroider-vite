...
import { AppMeta, Packager, PackagerInstance, Variant } from '@embroider/core';
...
export const Vite: Packager<Options> = class Vite implements PackagerInstance {
  ...
  async build(): Promise<void> {
    ...
    await build({
      ...
      plugins: [
        ...
        // This is necessary to handle `require` imports generated by Embroider's `importSync`
        commonjs(),

        // Users can provide additional plugins
